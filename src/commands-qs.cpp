...
bool CmdSummary::execute( Creature* creature, const std::vector<std::string>& args ) {
  ...
  avatar()->send( "{w||{xrace:   {g%-9s{x {w||{xstr: {G%2u{x/{g%2u{w ||{xhr/dr: {g%3u{x/{g%-3u{w    ||{xlevel: {g%3u{w      ||\n", avatar()->race().string().c_str(), avatar()->strength(), avatar()->maxStrength(), avatar()->hitroll(), avatar()->damroll(), avatar()->level() );
  avatar()->send( "{w||{xclass:  {g%-9s{x {w||{xdex: {G%2u{x/{g%2u{w ||{xsaves: {g%-5d{w      ||{xhp:   {G%4u{x/{g%-4u{w ||\n", avatar()->pClass().string().c_str(), avatar()->dexterity(), avatar()->maxDexterity(), avatar()->saves(), avatar()->hp(), avatar()->maxHp() );
  avatar()->send( "{w||{xgender: {g%-7s{x   {w||{xcon: {G%2u{x/{g%2u{w ||                  {w||{xmana: {C%4u{x/{c%-4u{w ||\n", avatar()->gender().string().c_str(), avatar()->constitution(), avatar()->maxConstitution(), avatar()->mana(), avatar()->maxMana() );
  avatar()->send( "{w||{xage:    {g%-3u{x       {w||{xint: {G%2u{x/{g%2u{w ||{xarmor class: {g%-4d{w ||{xmove: {M%4u{x/{m%-4u{w ||\n", avatar()->age(), avatar()->intelligence(), avatar()->maxIntelligence(), avatar()->ac(), avatar()->movement(), avatar()->maxMovement() );
  avatar()->send( "{w||{xhand:   {g%-5s{x     {w||{xwis: {G%2u{x/{g%2u{w || {x-bash:   {g%-4d{w    ||{xexp: {g%-9u{w  ||\n", "-", avatar()->wisdom(), avatar()->maxWisdom(), avatar()->bash(), avatar()->exp() );
  avatar()->send( "{w||{xheight: {g%-9s{x {w||{xcha: {G%2u{x/{g%2u{w || {x-slash:  {g%-4d{w    ||{xtnl: {g%-7u{w    ||\n", "-", avatar()->charisma(), avatar()->maxCharisma(), avatar()->slash(), avatar()->tnl() );
  avatar()->send( "{w||{xweight: {g%-9s{x {w||           || {x-pierce: {g%-4d{w    ||{xpracs: {g%-4u{w     ||\n", "-", avatar()->pierce(), avatar()->practices() );
  avatar()->send( "{w||{xtotem:  {g%-9s{x {w||           || {x-exotic: {g%-4d{w    ||{xpoints: {g%-4u{w    ||\n", "-", avatar()->exotic(), avatar()->points() );
  avatar()->send( "{w||__________________||___________||__________________||________________||\n" );
  avatar()->send( "{w||_____________________________________________________________________||\n" );
